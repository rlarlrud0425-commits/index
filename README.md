# index[mainpage.html](https://github.com/user-attachments/files/23111546/mainpage.html)
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  <div class="box p-contents1">
    <img class="box-img" src="./image/sect1img.png" alt="다낭 특가 이미지">
  ...
  <div class="tour-wrap">
    <div class="tour-list">
      <div class="tour">
        ...
        <div class="p-contents">
          <p>[파리] 노보텔 파리 레 알</p>
          <p>지하철역 입구 바로 앞에 완벽한 위치에 위치하고 있어서 편했습니다. 주변에는 정말 많은 수의 레스토랑과 바들이 있습니다. 방은 매우 아늑하고, 편 안했으며 아침 식사는 훌륭했습니다! 다만 호텔 주변에 공사중이라 소음이 ...</p>
        </div>
      </div>
